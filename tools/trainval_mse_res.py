...
from model import UNetTestRes
from datasets import CrowdDataset
from utils import custom_collate_fn
from utils.metrics import PointsMetrics
from utils.engine.test_res import train_one_epoch, val_one_epoch
...
def main(args):
    ...
    model = UNetTestRes(in_channels=3, num_class=args.num_classes, bilinear=args.bilinear)
    model.to(device)
...
if __name__ == "__main__":
    from configs.train_mse_res import args_parser
    args = args_parser()
